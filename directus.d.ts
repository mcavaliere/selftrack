...
export interface paths {
  ...
  "/items/event_definitions": {
    /** List the event_definitions items. */
    get: operations["readItemsEventDefinitions"];
    /** Create a new event_definitions item. */
    post: operations["createItemsEventDefinitions"];
  };
  "/items/event_definitions/{id}": {
    /** Retrieve a single event_definitions item by unique identifier. */
    get: operations["readSingleItemsEventDefinitions"];
    /** Delete an existing event_definitions item. */
    delete: operations["deleteSingleItemsEventDefinitions"];
    /** Update an existing event_definitions item. */
    patch: operations["updateSingleItemsEventDefinitions"];
  };
  "/items/stat_definitions": {
    /** List the stat_definitions items. */
    get: operations["readItemsStatDefinitions"];
    /** Create a new stat_definitions item. */
    post: operations["createItemsStatDefinitions"];
  };
  "/items/stat_definitions/{id}": {
    /** Retrieve a single stat_definitions item by unique identifier. */
    get: operations["readSingleItemsStatDefinitions"];
    /** Delete an existing stat_definitions item. */
    delete: operations["deleteSingleItemsStatDefinitions"];
    /** Update an existing stat_definitions item. */
    patch: operations["updateSingleItemsStatDefinitions"];
  };
  "/items/stat_recording_values_boolean": {
    /** List the stat_recording_values_boolean items. */
    get: operations["readItemsStatRecordingValuesBoolean"];
    /** Create a new stat_recording_values_boolean item. */
    post: operations["createItemsStatRecordingValuesBoolean"];
  };
  "/items/stat_recording_values_boolean/{id}": {
    /** Retrieve a single stat_recording_values_boolean item by unique identifier. */
    get: operations["readSingleItemsStatRecordingValuesBoolean"];
    /** Delete an existing stat_recording_values_boolean item. */
    delete: operations["deleteSingleItemsStatRecordingValuesBoolean"];
    /** Update an existing stat_recording_values_boolean item. */
    patch: operations["updateSingleItemsStatRecordingValuesBoolean"];
  };
  "/items/stat_recording_values_integer": {
    /** List the stat_recording_values_integer items. */
    get: operations["readItemsStatRecordingValuesInteger"];
    /** Create a new stat_recording_values_integer item. */
    post: operations["createItemsStatRecordingValuesInteger"];
  };
  "/items/stat_recording_values_integer/{id}": {
    /** Retrieve a single stat_recording_values_integer item by unique identifier. */
    get: operations["readSingleItemsStatRecordingValuesInteger"];
    /** Delete an existing stat_recording_values_integer item. */
    delete: operations["deleteSingleItemsStatRecordingValuesInteger"];
    /** Update an existing stat_recording_values_integer item. */
    patch: operations["updateSingleItemsStatRecordingValuesInteger"];
  };
  "/items/stat_recordings": {
    /** List the stat_recordings items. */
    get: operations["readItemsStatRecordings"];
    /** Create a new stat_recordings item. */
    post: operations["createItemsStatRecordings"];
  };
  "/items/stat_recordings/{id}": {
    /** Retrieve a single stat_recordings item by unique identifier. */
    get: operations["readSingleItemsStatRecordings"];
    /** Delete an existing stat_recordings item. */
    delete: operations["deleteSingleItemsStatRecordings"];
    /** Update an existing stat_recordings item. */
    patch: operations["updateSingleItemsStatRecordings"];
  };
  "/items/stat_recordings_value": {
    /** List the stat_recordings_value items. */
    get: operations["readItemsStatRecordingsValue"];
    /** Create a new stat_recordings_value item. */
    post: operations["createItemsStatRecordingsValue"];
  };
  "/items/stat_recordings_value/{id}": {
    /** Retrieve a single stat_recordings_value item by unique identifier. */
    get: operations["readSingleItemsStatRecordingsValue"];
    /** Delete an existing stat_recordings_value item. */
    delete: operations["deleteSingleItemsStatRecordingsValue"];
    /** Update an existing stat_recordings_value item. */
    patch: operations["updateSingleItemsStatRecordingsValue"];
  };
  "/activity": {
...
export interface components {
  schemas: {
    ...
    ItemsStatRecordingValuesBoolean: {
      id?: number;
      sort?: number | null;
      user_created?: (string | components["schemas"]["Users"]) | null;
      date_created?: string | null;
    ...
    ItemsStatRecordingValuesInteger: {
      id?: number;
      sort?: number | null;
      user_created?: (string | components["schemas"]["Users"]) | null;
      date_created?: string | null;
    ...
    ItemsStatRecordings: {
      ...
      date_updated?: string | null;
      stat_definition?:
        | (number | components["schemas"]["ItemsStatDefinitions"])
        | null;
      value?: (number | components["schemas"]["ItemsStatRecordingsValue"])[];
    };
    ItemsStatRecordingsValue: {
      id?: number;
      stat_recordings_id?:
        | (number | components["schemas"]["ItemsStatRecordings"])
        | null;
...
export interface operations {
  ...
  readItemsEventDefinitions: {
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsEventDefinitions"][];
  ...
  createItemsEventDefinitions: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsEventDefinitions"][]
          | components["schemas"]["ItemsEventDefinitions"];
      };
    };
  };
  /** Retrieve a single event_definitions item by unique identifier. */
  readSingleItemsEventDefinitions: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing event_definitions item. */
  deleteSingleItemsEventDefinitions: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing event_definitions item. */
  updateSingleItemsEventDefinitions: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsEventDefinitions"];
      };
    };
  };
  /** List the stat_definitions items. */
  readItemsStatDefinitions: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsStatDefinitions"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsStatDefinitions: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsStatDefinitions"][]
          | components["schemas"]["ItemsStatDefinitions"];
      };
    };
  };
  /** Retrieve a single stat_definitions item by unique identifier. */
  readSingleItemsStatDefinitions: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing stat_definitions item. */
  deleteSingleItemsStatDefinitions: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing stat_definitions item. */
  updateSingleItemsStatDefinitions: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsStatDefinitions"];
      };
    };
  };
  /** List the stat_recording_values_boolean items. */
  readItemsStatRecordingValuesBoolean: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsStatRecordingValuesBoolean"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  /** Create a new stat_recording_values_boolean item. */
  createItemsStatRecordingValuesBoolean: {
    parameters: {
      query: {
        /** What metadata to return in the response. */
        meta?: components["parameters"]["Meta"];
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsStatRecordingValuesBoolean"][]
          | components["schemas"]["ItemsStatRecordingValuesBoolean"];
      };
    };
  };
  /** Retrieve a single stat_recording_values_boolean item by unique identifier. */
  readSingleItemsStatRecordingValuesBoolean: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing stat_recording_values_boolean item. */
  deleteSingleItemsStatRecordingValuesBoolean: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing stat_recording_values_boolean item. */
  updateSingleItemsStatRecordingValuesBoolean: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsStatRecordingValuesBoolean"];
      };
    };
  };
  /** List the stat_recording_values_integer items. */
  readItemsStatRecordingValuesInteger: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsStatRecordingValuesInteger"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  /** Create a new stat_recording_values_integer item. */
  createItemsStatRecordingValuesInteger: {
    parameters: {
      query: {
        /** What metadata to return in the response. */
        meta?: components["parameters"]["Meta"];
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsStatRecordingValuesInteger"][]
          | components["schemas"]["ItemsStatRecordingValuesInteger"];
      };
    };
  };
  /** Retrieve a single stat_recording_values_integer item by unique identifier. */
  readSingleItemsStatRecordingValuesInteger: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing stat_recording_values_integer item. */
  deleteSingleItemsStatRecordingValuesInteger: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing stat_recording_values_integer item. */
  updateSingleItemsStatRecordingValuesInteger: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsStatRecordingValuesInteger"];
      };
    };
  };
  /** List the stat_recordings items. */
  readItemsStatRecordings: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsStatRecordings"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  createItemsStatRecordings: {
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsStatRecordings"][]
          | components["schemas"]["ItemsStatRecordings"];
      };
    };
  };
  /** Retrieve a single stat_recordings item by unique identifier. */
  readSingleItemsStatRecordings: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing stat_recordings item. */
  deleteSingleItemsStatRecordings: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing stat_recordings item. */
  updateSingleItemsStatRecordings: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsStatRecordings"];
      };
    };
  };
  /** List the stat_recordings_value items. */
  readItemsStatRecordingsValue: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    responses: {
      ...
      200: {
        content: {
          "application/json": {
            data?: components["schemas"]["ItemsStatRecordingsValue"][];
            meta?: components["schemas"]["x-metadata"];
          };
        };
      };
  ...
  /** Create a new stat_recordings_value item. */
  createItemsStatRecordingsValue: {
    parameters: {
      query: {
        /** What metadata to return in the response. */
        meta?: components["parameters"]["Meta"];
    ...
    requestBody: {
      content: {
        "application/json":
          | components["schemas"]["ItemsStatRecordingsValue"][]
          | components["schemas"]["ItemsStatRecordingsValue"];
      };
    };
  };
  /** Retrieve a single stat_recordings_value item by unique identifier. */
  readSingleItemsStatRecordingsValue: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
  ...
  /** Delete an existing stat_recordings_value item. */
  deleteSingleItemsStatRecordingsValue: {
    parameters: {
      path: {
        /** Index of the item. */
        id: number | string;
  ...
  /** Update an existing stat_recordings_value item. */
  updateSingleItemsStatRecordingsValue: {
    parameters: {
      query: {
        /** Control what fields are being returned in the object. */
        fields?: components["parameters"]["Fields"];
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["ItemsStatRecordingsValue"];
      };
    };
  };
  /** Returns a list of activity actions. */
...
export type Directus = {
  event_definitions: components["schemas"]["ItemsEventDefinitions"];
  stat_definitions: components["schemas"]["ItemsStatDefinitions"];
  stat_recording_values_boolean: components["schemas"]["ItemsStatRecordingValuesBoolean"];
  stat_recording_values_integer: components["schemas"]["ItemsStatRecordingValuesInteger"];
  stat_recordings: components["schemas"]["ItemsStatRecordings"];
  stat_recordings_value: components["schemas"]["ItemsStatRecordingsValue"];
};